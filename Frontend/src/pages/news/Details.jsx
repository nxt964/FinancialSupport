...
const Details = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex-1 bg-white text-gray-900">
      {loading && <Loading />}
      ...
      {article && (
        <div className="w-full max-w-5xl mx-auto h-full min-h-screen px-4 sm:px-6 lg:px-8 py-10">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  >
                    <svg
                      class="rtl:rotate-180 size-5 text-gray-400 mx-1"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 6 10"
          ...
          {/* Meta Info */}
          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 bg-gray-50 rounded-md px-4 py-3 mb-6 shadow-sm">
            <span>
              By{" "}
            ...
            {article.sentimentScore && (
              ...
              `}
              >
                {article.sentimentLabel} ({article.sentimentScore})
              </span>
            )}
          </div>
